...
| Environmental, Social, and Governance (ESG) Scores by Global Reporting Initiative (GRI) | TODO                                                         |                                                              |                                                              |
| Life Cycle Assessment (LCA)                                  | Evaluates the environmental impacts associated with all the stages of the life cycle of a commercial product, process, or service. TODO | ISO 14040 and ISO 14044 for LCA                              | TODO find out where to get definition for free               |

#### Useful metrics for IT projects

Not all of the above mentioned metrics lend themselves well to IT projects. A metric should be evaluated under the following considerations

- It should not create an misaligned incentive + create an incentive to improve the product as intended
